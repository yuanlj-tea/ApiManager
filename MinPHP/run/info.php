        ...
        <div style="background:#f5f5f5;padding:20px;position:relative">
            ...
            <div style="margin-left:20px;">
                <form action="?act=api&tag=<?php echo $_GET['tag']?>&type=do&op=add" method="post">
                    ...
                    <div class="form-group">
                        <h5>返回结果</h5>
                        <textarea name="re" rows="30" class="form-control" placeholder="返回结果"></textarea>
                    </div>
                    <div class="form-group">
                        <h5>备注</h5>
        ...
        <div style="background:#f5f5f5;padding:20px;position:relative">
            ...
            <div style="margin-left:20px;">
                <form action="?act=api&tag=<?php echo $_GET['tag']?>&type=do&op=edit" method="post">
                    ...
                    <div class="form-group">
                        <h5>返回结果</h5>
                        <textarea name="re" rows="30" class="form-control" placeholder="返回结果"><?php echo $info['re']?></textarea>
                    </div>
                    <div class="form-group">
                        <h5>备注</h5>
